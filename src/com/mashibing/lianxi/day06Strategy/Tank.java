...
import com.mashibing.lianxi.day06Strategy.strategy.DefaultFireStrategy;
import com.mashibing.lianxi.day06Strategy.strategy.FireStrategy;
...
public class Tank {
    ...
    private void move() {
        ...
        if(this.group== Group.BAD && random.nextInt(100)>95) {
            ...
            //方法一：通过配置文件，DefaultFireStrategy，构造方式是private的，不支持反射
           /* String fsName = (String)PropertyMgr.get("badFireStrategy");
