...
import com.mashibing.lianxi.day09CodeRefactor.collider.Collider;
...
public class PropertyMgr {
    ...
    static {
        try {
            pros.load(PropertyMgr.class.getClassLoader().getResourceAsStream("com/mashibing/lianxi/day09CodeRefactor/config"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
