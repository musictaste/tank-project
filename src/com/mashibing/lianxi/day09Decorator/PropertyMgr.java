...
import com.mashibing.lianxi.day09Decorator.collider.Collider;
...
public class PropertyMgr {
    ...
    static {
        try {
            pros.load(PropertyMgr.class.getClassLoader().getResourceAsStream("com/mashibing/lianxi/day09Decorator/config"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
